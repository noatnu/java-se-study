...
public class ZhouCalendarUtil {
	 ...
	 * @return
	 */
	public static Date formate_(String text){
	...
	/**
	 * ["yyyy-MM-dd'T'HH:mm:ss.SSSZ","yyMMddHHmmssZ","h:mm a"] 等
	 * @param text
	 * @param pattern
	 * @return
	 */
	public static Date formate(String text,String pattern){
