...
public class ChineseToPy {
     ...
     * @return 返回转换后的拼
     */
    public static String getFirstSpell(String cnStr) throws UnsupportedEncodingException {
        return getspellAll(cnStr, 1);
    }
     ...
     * @return
     */
    public static String getFirst(String cnStr) throws UnsupportedEncodingException {
        return getspellAll(cnStr, 2);
    }
     ...
     *
     * @param cnStr 中文
     * @param type  1、首字全拼其它拼音首字，2、拼音首字，3、全拼
     * @return
     */
    private static String getspellAll(String cnStr, Integer type) throws UnsupportedEncodingException {
