 ...
 * 自定义布局
 */
public class SwingDemo0602  extends RunAbs
{
    @Test
    public void testRun(){
        JLabel a1 = SwingUtils.getJLabel("Hello,World");
        JLabel a2 = SwingUtils.getJLabel("样例文本");
        JFrame jFrame = SwingUtils.getJFrame();
        Container container = jFrame.getContentPane();


        // 设置一个自定义的布局器
        LayoutManager layoutMgr = new SimpleLayout(a1,a2);
